...
export default function AudioPlaybackPage() {
  ...
  const loadBookAndAudioFiles = async () => {
    try {
      ...
      const processedAudioFiles = (response.data.audioFiles || []).map((file: any) => ({
        ...file,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900">音频播放</h1>
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium">
                        {formatFileSize(audioFiles.reduce((total, file) => total + file.fileSize, 0))}
                      </span>
                    </div>
                  </div>
                </CardContent>
